...
export const KNOWLEDGE: readonly KnowledgeEntry[] = [
  ...
  /* ---------------- bio-bitumen + pyrolysis ---------------- */
  {
    ...
    answer:
      "Bio-bitumen replaces 15–30% of conventional VG-30 with bio-oil made from agro-waste via pyrolysis (450–550°C), to the CSIR-CRRI 'KrishiBind' specification. It meets NHAI/MoRTH specs with equal or better road performance — and India became the first country to commercially produce it in January 2026.",
