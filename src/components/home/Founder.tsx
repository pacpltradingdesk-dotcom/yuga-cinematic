        ...
        <div>
          ...
          <Reveal index={2}>
            <p className="mt-6 max-w-xl leading-relaxed text-[var(--color-muted)]">
              A 25-year bitumen-industry veteran and company director. Founder of Omnipotent Industries, a
              bitumen company listed on the BSE SME platform (2021). Rare first-hand listing and
